...
const NAV_HTML = `
  <nav id="nav">
    <div class="nav-inner">
      <a class="nav-logo" href="/index.html"><img src="/logo-ara.svg" alt="Ara An" style="height:22px;width:auto;display:block;"></a>
      <ul class="nav-links">
...
const PROJECTS = [
  ...
  { slug: 'espn-bet-onboarding', company: 'theScore Bet & ESPN Bet', label: 'Redesigning the Sign-Up Flow',               href: 'espn-bet-onboarding.html', bg: '#2D387F', thumb: 'images/espnbet-thumbnail.png' },
